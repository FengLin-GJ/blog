...
public enum CodeType {
    ...
    ADD_FRIEND_LINK_SUCCESS(601, "添加链接成功"),
    FRIEND_LINK_EXIST(602, "链接已存在"),
    UPDATE_FRIEND_LINK_SUCCESS(603, "更新链接成功"),
    DELETE_FRIEND_LINK_SUCCESS(604, "删除链接成功"),
