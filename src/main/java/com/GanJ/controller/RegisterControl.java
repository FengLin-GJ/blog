...
import com.GanJ.aspect.PrincipalAspect;
...
public class RegisterControl {
    ...
    public String register(User user,
        ...
        try {
            ...
            userService.uploadTxt("user/avatar/"+user.getUsername(),user.getUsername());
            userService.uploadPng(user.getUsername());
            //注册结果
