...
import com.GanJ.dao.CommentRepository;
...
import com.GanJ.service.CommentService;
...
public class CommentServiceImpl implements CommentService {
    ...
    public DataMap findCommentByArticleId(long articleId, String username) {
        ...
        List<Comment> commentLists = commentRepository.findByArticleIdAndPIdOrderByIdDesc(articleId, 0);
        ...
        for (Comment comment : commentLists) {
            ...
            replyLists = commentRepository.findByArticleIdAndPId(articleId, comment.getId());
    ...
    public DataMap updateLikeByArticleIdAndId(long articleId, long id) {
        commentRepository.updateLikeByArticleIdAndId(articleId, id);
        int liked = commentRepository.findLikesByArticleIdAndId(articleId, id);
    ...
    public DataMap findFiveNewComment(int rows, int pageNum) {
        ...
        List<Comment> fiveComments = commentRepository.findByOrderByIdDesc();
    ...
    public DataMap getUserComment(int rows, int pageNum, String username) {
        ...
        PageHelper.startPage(pageNum, rows);
        List<Comment> comments = commentRepository.findAllByRespondentIdAndAnswererIdNotOrderByIdDesc(userId, userId);
        ...
        returnJson.put("msgIsNotReadNum", commentRepository.countAllByIsReadAndRespondentIdAndAnswererIdNot(1, userId, userId));
    ...
    public void readOneCommentRecord(int id) {
        commentRepository.readCommentRecordById(id);
    }

    @Override
    public void readAllComment(String username) {
        int respondentId = userService.findIdByUsername(username);
        commentRepository.readCommentRecordByRespondentId(respondentId);
    }
